<?php
    ...
    if(isset($_POST['create']))
    {
        ...
        if(mysqli_query($con,$sql1))
        {
            ...
            header("location:success_Rinvoice.php");
        }
        else
        {
            ...
            <div class="container-fluid" style="//border:1px solid red;background:black">  
                <nav class="navbar navbar-expand-sm navbar-dark" style="background:black;//border:1px solid red;">
                 ...
                 <div class="collapse navbar-collapse" id="collapsibleNavbar">
                   <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="../files/welcome_r.php" style="float:right;margin-right:10px;padding:10px">Home</a>
                            
                       </li>
                       <li class="nav-item">
                            <a href="../files/regular.php" style="float:right;margin-right:10px;padding:10px">Create Invoices</a>
                            
                       </li>
                       <li>
                            <a href="../files/view_Rinvoices.php" style="float:right;margin-right:10px;padding:10px">View Invoices</a>
                       </li>
                     </ul>
