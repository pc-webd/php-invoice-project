                   ...
                   <div class="row" style="//border:1px solid red">
                    ...
                    <div class="col-md-12" style="//border:1px solid yellow">
                        <div class="loginbox">
                            ...
                            <p style="background:#808080;color:white;padding-left:2px" id="emailALE">This GSTIN Number has already Exist. Please Try Different GSTIN No.</p>
...
<!-- jQuery library -->
    ...
    function checkpsw()
        ...
        function gstnExist()
        {
             swal( "Oops" ,  "GSTIN is already Exist " ,  "error" );
        }
          function toUpper()
        {
