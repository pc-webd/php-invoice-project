    ...
    if(isset($_GET["pdf"]) && isset($_GET["id"]))
       {
           ...
           $statement=$connect->prepare("
              SELECT * FROM invoice_data WHERE order_id=:order_id AND user_id=:user_id
              LIMIT 1
           ");
            $statement->execute(
                    array(
                ...
                $output .='
                        ...
                        <body>
                            ...
                            $output .=' <div class="row" style="//border:1px solid red">
                                    ...
                                    <div class="col-md-6" style="//margin-top:26px;//border:1px solid blue;width:29%;float:right">
                                        <table>
                                            <tr>
                                                <th>Invoice No.</th>
                                                 <td>&nbsp;&nbsp;</td>
                         ...
                         $statement=$connect->prepare("
                          SELECT * FROM invoice_item WHERE order_id=:order_id AND user_id=:user_id
                       ...
                       ");
                        ...
                        $output .='
                                ...
                                <div class="row">
                                   ...
                                   <p align="right"> <span style=""><i>'.$row["sign"].'</i></span><br>
