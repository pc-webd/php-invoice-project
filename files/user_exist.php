       ...
       <!--Add the Sign  up Form--> 
        ...
        <div class="container-fluid diagonal">
            <div class="row" style="//border:1px solid red;">
                   ...
                   <div class="row" style="//border:1px solid red">
                    ...
                    <div class="col-md-12" style="//border:1px solid yellow">
                        <div class="loginbox">
                            ...
                            <p style="background:#808080;color:white;padding-left:2px" id="emailALE">This email address has already signed up for an account. Please Try Different Email.</p>
                ...
                <!--Add the Footer-->
                <div class="row footer" style="//border:1px solid red;//margin-top:-10px;">
                    <div class="col-md-12" style="//border:1px solid black;">
                        <p class="copyright wow bounceInRight"  data-wow-delay="5.2s"> &copy;2019 SPT Invoice.</p>
                         <p  id="call"><i class="material-icons wow bounceInLeft"  data-wow-delay="5.6s" style="font-size:18px;padding-top:2px;">call</i> 9634704464</p>
                    </div>
                </div>
            </div>
    </body>
...
<!-- jQuery library -->
    ...
    function checkpsw()
        ...
        function emailExist()
        {
             swal( "Oops" ,  "Email is already Exist" ,  "error" );
        }
       function toUpper()
        {
