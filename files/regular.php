...
<head>
    ...
    <meta charset="UTF-8">
    <title>Create Regular Invoice</title>
     <meta charset="UTF-8">
...
<body>
    ...
    <form action="../action_files/success_Rinvoice.php" method="post">
            ...
            <div class="col-md-6" style="//border:1px solid blue">
                <table class="" style="margin-top:50px;" align="right"  cellpadding="3px" id="invoice_details">
                    ...
                    <tr>
                        ...
                        <td  style="padding-top:8px"><input type="text" id="inv_date" name="date"  required="required"></td>
                    </tr>
                </table>
            </div>       
        </div>
        <div class="row" style="margin-top:50px;//border:1px solid blue">
                <div class="col-md-12">
                   <div class="table-responsive">
                    <table  class="table autocomplete_table"  style="border:border-collapse;min-height:150px;//margin-left:20px" border="2" cellpadding="2px" id="autocomplete_table">
                       <thead class="thead-light">
                        ...
                        <tbody id="myTab">
                            <tr align="center" id="row_1">
                                ...
                                <td><input type="number" onblur="findTotal(),Grandtotal()" id="qty_1" data-type="qty1" name="qty[]" class="form-control autocomplete_txt" autocomplete="off" required="required"></td>
                                <td><input type="number" id="rate_1" data-type="rate1" name="rate[]" class="form-control autocomplete_txt" autocomplete="off" onblur="findTotal(),Grandtotal()" required="required"></td>
                                <td><input type="number" id="dis_1" data-type="dis1" name="dis[]" class="form-control autocomplete_txt" autocomplete="off" onblur="findTotal(),Grandtotal()" required="required"></td>
                       ...
                       <p align="right"><b>Grand Total &#61;</b> <input type="number" id="grandSum" name="grandtotal" style="margin-right:5px;text-align:center;//border:none" readonly ></p>
                    </div>
            ...
            <div class="row" style="//border:1px solid red">
                <div class="col-md-12" style="//border:1px solid red;padding-top:20px;">
                   <!--<div style="float:right;display:inline-block;//border:1px solid red">-->
                   <table align="right" style="text-align:center" cellpadding="8px" id="gstCalc">
                    <tr>
                        
                        <td><p style="float:left"><b>GST <sup style="color:red">&#42;</sup></b></p> </td>
                        <td>
                            <select name="gst_type_1" required="required" id="gst_type1" style="//margin-left:27px" onchange="total()">
                        ...
                        <td>
                            <select name="gst_rate_1" required="required" id="gst_rate1" onchange="total(),NumToWord(finalTotal.value,'divDisplayWords');" style="//margin-left:27px">
                        ...
                        <td><input type="number" id="total1" name="total_1" style="text-align:center;//margin-left:5px" readonly="readonly"></td>
                    </tr>
                    <tr>
                        <td></td>
                    <td>
                        <select name="gst_type_2" id="gst_type2" style="//margin-left:70px" onchange="total()">
                            <option value="">--Choose One-- </option>
                        </select>
                    </td>
                    <td>
                         <select name="gst_rate_2" id="gst_rate2" style="//margin-left:30px" onchange="total(), NumToWord(finalTotal.value,'divDisplayWords');">
                            <option value="0">0 &#37;</option>
                            <option value="2.5">2.5 &#37;</option>
                            <option value="6">6 &#37;</option>
                            <option value="9">9 &#37;</option>
                        ...
                        <td><input type="number" id="total2" name="total_2" style="text-align:center;//margin-left:5px" readonly="readonly"></td>
                </tr>
    
                <tr>
                    <td></td>
                    <td><p style="//margin-left:255px"><b>Total</b></p></td>
                    <td>&#61;</td>
                    <td><input type="number" readonly="readonly" id="finalTotal" name="final_total" onkeypress="return onlyNumbers(this.value);"  style="//margin-left:15px;text-align:center;//width:180px" onmouseout="NumToWord(this.value,'divDisplayWords');"></td>
                </tr>
                     </table>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12" style="//border:1px solid red">
                   <div class="wrapper">
                    <button class="btn-success butn" type="submit" name="create" style="//margin:0px 0px 20px 550px;border:none;height:40px">Create Invoice</button>
    ...
    <!---FOr the Gst SEction-->
      <script>
            $(document).ready(function () {
                $("#gst_type1").change(function () {
                    var val = $(this).val();
                    if (val === 'CGST') {
                        $("#gst_type2").prop('disabled', false);
                        $("#gst_rate2").prop('disabled', false);
                        $("#total2").prop('disabled', false);
                        $("#gst_rate1").html("<option value='0'>0 &#37;</option><option value='2.5'>2.5&#37;</option><option value='6'>6&#37;</option><option value='9'>9&#37;</option><option value='14'>14 &#37;</option>");
                        $("#gst_rate2").html("<option value='0'>0 &#37;</option><option value='2.5'>2.5&#37;</option><option value='6'>6&#37;</option><option value='9'>9&#37;</option><option value='14'>14 &#37;</option>");
                        $("#gst_type2").html("<option value='SGST'>SGST</option>");
                        $('#total1').val(0);
                    }
                    ...
                    if(val==='SGST'){
                        $("#gst_type2").prop('disabled', false);
                        $("#gst_rate2").prop('disabled', false);
                        $("#gst_type2").html("<option value='CGST'>CGST</option>");
                    }

                    if(val=='IGST'){  
                        $("#gst_rate1").html("<option value='0'>0 &#37;</option><option value='5'>5&#37;</option><option value='12'>12&#37;</option><option value='18'>18&#37;</option><option value='28'>28 &#37;</option>")
                        if($('#gst_rate1').val() == 0){
                           $('#total1').val(0);
                           var grandSum=$('#grandSum').val();
                           $('#finalTotal').val(grandSum);
                        }
                        $("#gst_type2").prop('disabled', true);
                        $("#gst_rate2").prop('disabled', true);
                        $("#total2").prop('disabled', true);

                        if( $("#gst_type2").prop('disabled', true)!=""){
                            $("#gst_rate2").html("<option value='0'>0</option>");
                                document.getElementById('total2').value=0;
                            }
                    }
                    if(val==''){
                        $("#gst_type2").html("<option value=''>--Choose One--</option>");
                    }
                });
            });
        </script>
    ...
    <script type="text/javascript">
        /*$(document).ready(function(){
            $('#myTab tr td input').keydown(function(){
        ...
        function total()
{
    var cgst_rate=document.getElementById('gst_rate1').value;
    var sgst_rate=document.getElementById('gst_rate2').value;
    var grandSum1=document.getElementById('grandSum').value;
    var total1= grandSum1 * cgst_rate/100;
    var total2= grandSum1 * sgst_rate/100;
    var x1= + grandSum1;
    var y1= + total1;
    var z1= + total2;
    var final_total= x1 + y1 + z1;
    var round_final_total=Math.round(final_total);
    document.getElementById('total1').value=total1;
    document.getElementById('total2').value=total2;
    document.getElementById('finalTotal').value=round_final_total;
 ...
 <script>
   ...
   rowcount= $("#autocomplete_table tbody tr").length+1;
    ...
    function formHtml(){
                            ...
                            html += '</td>';
                            html += '<td>';
                            html += '<input type="number" onfocusout="findTotal(),Grandtotal()" id="qty_'+rowcount+'" data-type="qty'+rowcount+'" name="qty[]" class="form-control  autocomplete_txt" autocomplete="off">';
                            html += '</td>';
                            html += '<td>';
                            html += '<input type="number" onblur="findTotal(),Grandtotal()" id="rate_'+rowcount+'" data-type="rate'+rowcount+'" name="rate[]" class="form-control autocomplete_txt" autocomplete="off">';
                            html += '</td>';
                            html += '<td>';
                            html += '<input type="number" onblur="findTotal(),Grandtotal()" id="dis_'+rowcount+'" data-type="dis'+rowcount+'" name="dis[]" class="form-control autocomplete_txt"   autocomplete="off">';
                            html += '</td>';
                            html += '<td>';
