...
<head>
    ...
    <style>
        ...
        {
            .loginbox{width:100%;margin:auto;margin-top: 120px;//margin-left: 20px}
       ...
       @media screen and (max-width: 600px) and (min-width: 350px)
        {
            .loginbox{width:100%;margin: auto;margin-top: 120px;}
            .overlay .closebtn{right:15px;position: absolute}
            #line{font-size: 15px}
            #usericon{font-size: 28px;}
            .input-grp{display: block;margin: auto;justify-content: center}
            #pswBox{margin:auto;display: block; margin-top: 20px;justify-content: center} 
            .inp{height:40px;}
            .input-grp span{top:8px}
            .input-container input,textarea{font-size:14px;}
            #loginbtn{width:285px;height:40px;font-size: 15px;justify-content: center}
        ...
        @media only screen and (max-width:349px)
        {
            ...
            #line{font-size: 15px}
            #usericon{font-size: 28px;}
             .input-grp{display: flex;margin: auto;justify-content: center;}
             #pswBox{margin:auto;margin-top: 20px;justify-content: center} 
            .inp{height:40px;width:275px}
            .input-grp span{top:8px}
             .input-container input,textarea{font-size:12px;}
             #loginbtn{width:275px;justify-content: center;height:40px;font-size: 15px}
            #eye{top:2px;position: absolute;}
    ...
    <body>    
       <!--Add the Sign Up Form-->
                    ...
                    <form action="OTP/otp.php" style="max-width:500px;margin:auto" method="post" enctype="multipart/form-data" name="myForm" onsubmit="return checkpsw()">
                        ...
                        <div class="input-container">
                           <i class='fas fa-file-code icons'></i>
                            <input class="input-field" type="text" maxlength="15" minlength="15" placeholder="GSTIN No." onblur="toUpper()" id="gstn" name="gstin" required="required">
        ...
        <!--End the SignUp And Add the Header-->
            ...
            <div class="row" style="//border:1px solid red;">
                  ...
                  <!--Add the login Box-->
                   <div class="row" style="//border:1px solid red">
                    ...
                    <div class="col-md-12" style="//border:1px solid yellow">
                        <div class="loginbox">
                            <center><i class='fas fa-user-circle wow fadeInUp' id="usericon"  data-wow-delay="2.0s" style="color:#041e42"></i></center><center>
                            <b><p align="center" style="padding-top:10px;color:#041e42;letter-spacing:4px;  font-family: 'Raleway', 'Open Sans', sans-serif" class="wow fadeInUp" id="line"  data-wow-delay="2.4s">Login Your Account</p></b><hr class="wow fadeInUp"  data-wow-delay="2.8s"></center>
                            <center>
                ...
                <div class="row footer" style="//border:1px solid red;//margin-top:9px;">
                    <div class="col-md-12" style="//border:1px solid black;">
                        ...
                        <p  id="call" class="wow bounceInLeft" data-wow-delay="5.6s"><i class="material-icons"  style="font-size:18px;padding-top:2px;">call</i> 9634704464</p>
                    </div>
                </div>
            </div>
    </body>
...
<!-- jQuery library -->
    ...
    function checkpsw()
        ...
        {
            var pwd=document.getElementById('psw_val').value;
             var gstn=document.getElementById('gstn').value;
            if(pwd.length<8)
                {
                     swal( "Oops" ,  "At Least Eight Or More Characters" ,  "error" ); 
                      return false;
                }
            if(gstn.length != 15)
            {
